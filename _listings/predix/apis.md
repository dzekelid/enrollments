...
created: "2018-08-27"
modified: "2018-08-27"
url: https://raw.githubusercontent.com/streamdata-gallery-topics/enrollments/master/_listings/predix/apis.md
specificationVersion: "0.14"
apis:
- name: Predix BlockChain API - Post Users Userid Enroll
  x-api-slug: v1usersuseridenroll-post
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enrollments/master/_listings/predix/v1usersuseridenroll-post-openapi.md
- name: Predix BlockChain API - Post Users Userid Enroll
  x-api-slug: v1usersuseridenroll-post
  description: Enrolls the blockchain user by downloading its certificates and storing
    it in Vault. It also maps the oauth user with the blockchain user. This is the
