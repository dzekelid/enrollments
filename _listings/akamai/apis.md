...
- name: Akamai API Get Change Status
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enrollments/master/_listings/akamai/cps-v2-enrollments-enrollmentid-changes-changeid-get.md
x-common:
- type: x-base
