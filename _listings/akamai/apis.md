...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery-topics/enrollments/master/_listings/akamai/cps-v2-enrollments-enrollmentid-deployments-production-get.md
x-common:
- type: x-base
