...
- name: Akamai API
  ...
  properties:
  - type: x-openapi-spec
    url: https://raw.githubusercontent.com/streamdata-gallery/enrollment/master/_listings/akamai/cps-v2-enrollments-enrollmentid-deploy-not-before,deploy-not-after,allow-cancel-pending-changes-put.md
x-common:
- type: x-base
